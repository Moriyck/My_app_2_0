...
const MyApps = (props) => {
  ...
  let all_apps = [
    ...
    },
    {
      ...
      "name": "easyeda",
      "to": "https://easyeda.com",
      "routPath": "/app/:appId?",
      "img": "http://localhost:5984/all_apps/12cf9d9c306bd6fb8fdcbcb54b00fe3f/5jjeasyeda.png"
    },
    {
      ...
      "to": " https://miro.com/",
      "routPath": "/app/:appId?",
      "img": "http://localhost:5984/all_apps/12cf9d9c306bd6fb8fdcbcb54b016e35/1594987997img.png"
    },
    {
